...
sub test_resolve_method {
    ...
    my %results_for = (
        get => {
            ...
            '/pet/{petId}'           => [ 'My::Project::Model::Pet',   'args_get', [qw/petId/] ],
            '/store/inventory'       => [ 'My::Project::Model::Store', 'get_inventory' ],
            '/store/order/{orderId}' => [ 'My::Project::Model::Store', 'args_get_order', [qw/orderId/] ],
            '/user/login'            => [ 'My::Project::Model::User',  'get_login' ],
            '/user/logout'           => [ 'My::Project::Model::User',  'get_logout' ],
            '/user/{username}'       => [ 'My::Project::Model::User',  'args_get', [qw/username/] ],
        },
        delete => {
            '/pet/{petId}'           => [ 'My::Project::Model::Pet',   'args_delete',       ['petId'] ],
            '/store/order/{orderId}' => [ 'My::Project::Model::Store', 'args_delete_order', [qw/orderId/] ],
            '/store/order'           => [ 'My::Project::Model::Store', 'delete_order' ],
            '/store/order/'          => [ 'My::Project::Model::Store', 'delete_order' ],
            '/user/{username}'       => [ 'My::Project::Model::User',  'args_delete', ['username'] ],
        },
        post => {
            '/pet'                     => [ 'My::Project::Model::Pet',   'post' ],
            '/pet/{petId}'             => [ 'My::Project::Model::Pet',   'args_post',               ['petId'] ],
            '/pet/{petId}/uploadImage' => [ 'My::Project::Model::Pet',   'args_post___uploadImage', ['petId'] ],
        ...
        put => {
            ...
            '/user/{username}' => [ 'My::Project::Model::User', 'args_put', ['username'] ],
        },
    );
