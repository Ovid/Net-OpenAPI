...
END
    ...
    my $expected = <<'END';
### <start: do not touch any code between this and the end comment. Checksum: "da4a8adfd9ad75321c955e0d226532a6">

It does me no injury for my neighbour to say there are 20 gods or no God. It neither picks my pocket nor breaks my leg.

— Thomas Jefferson

### <end: do not touch any code between this and the start comment. Checksum: "da4a8adfd9ad75321c955e0d226532a6">
END
...
### <start: do not touch any code between this and the end comment. Checksum: "24e8541b178780253dcddeb0d5883e19">
...
### <end: do not touch any code between this and the start comment. Checksum: "24e8541b178780253dcddeb0d5883e19">
